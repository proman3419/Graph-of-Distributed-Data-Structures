...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		RULE_functionMul = 16, RULE_functionDiv = 17, RULE_functionMod = 18, RULE_functionAbs = 19, 
		RULE_functionSet = 20, RULE_functionComp = 21, RULE_functionSwap = 22, 
		RULE_functionCopy = 23, RULE_functionDefineLabel = 24, RULE_functionJump = 25, 
		RULE_functionCheckIFEZ = 26, RULE_functionCheckIFNZ = 27, RULE_functionCheckIFLZ = 28, 
		RULE_functionCheckIFGZ = 29, RULE_functionExit = 30, RULE_functionPrint = 31, 
		RULE_functionPrintNL = 32, RULE_functionPrintChar = 33, RULE_functionPrintNLChar = 34, 
		RULE_functionWriteCell = 35, RULE_functionReadCell = 36, RULE_functionReadBus = 37, 
		RULE_functionCopyCell = 38, RULE_functionPrintLabelName = 39, RULE_functionPass = 40, 
		RULE_functionTerminate = 41, RULE_idArgument = 42, RULE_numberArgument = 43, 
		RULE_extendedDefinedLabel = 44, RULE_definedLabel = 45;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"functionDiv", "functionMod", "functionAbs", "functionSet", "functionComp", 
			"functionSwap", "functionCopy", "functionDefineLabel", "functionJump", 
			"functionCheckIFEZ", "functionCheckIFNZ", "functionCheckIFLZ", "functionCheckIFGZ", 
			"functionExit", "functionPrint", "functionPrintNL", "functionPrintChar", 
			"functionPrintNLChar", "functionWriteCell", "functionReadCell", "functionReadBus", 
			"functionCopyCell", "functionPrintLabelName", "functionPass", "functionTerminate", 
	...
	public final FunctionAbsContext functionAbs() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_functionAbs);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(234);
	...
	public final FunctionCheckIFNZContext functionCheckIFNZ() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_functionCheckIFNZ);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(257);
	...
	public final FunctionCheckIFLZContext functionCheckIFLZ() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_functionCheckIFLZ);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(260);
	...
	public final FunctionCheckIFGZContext functionCheckIFGZ() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_functionCheckIFGZ);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(263);
	...
	public final FunctionExitContext functionExit() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_functionExit);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(266);
	...
	public final FunctionPrintContext functionPrint() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_functionPrint);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(269);
	...
	public final FunctionPrintNLContext functionPrintNL() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_functionPrintNL);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(272);
	...
	public final FunctionPrintCharContext functionPrintChar() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_functionPrintChar);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(275);
	...
	public final FunctionPrintNLCharContext functionPrintNLChar() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_functionPrintNLChar);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(278);
	...
	public final FunctionWriteCellContext functionWriteCell() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_functionWriteCell);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(281);
	...
	public final FunctionReadCellContext functionReadCell() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_functionReadCell);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(284);
	...
	public final FunctionReadBusContext functionReadBus() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_functionReadBus);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(287);
	...
	public final FunctionCopyCellContext functionCopyCell() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_functionCopyCell);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(290);
	...
	public final FunctionPrintLabelNameContext functionPrintLabelName() throws RecognitionException {
		...
		enterRule(_localctx, 78, RULE_functionPrintLabelName);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(293);
	...
	public final FunctionPassContext functionPass() throws RecognitionException {
		...
		enterRule(_localctx, 80, RULE_functionPass);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(296);
	...
	public final FunctionTerminateContext functionTerminate() throws RecognitionException {
		...
		enterRule(_localctx, 82, RULE_functionTerminate);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(299);
