...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		PRINTNL=26, PRINT_CHAR=27, PRINTNL_CHAR=28, WRITE_CELL=29, READ_CELL=30, 
		COPY_CELL=31, PRINT_LABEL_NAME=32, PASS=33, NUMBER=34, ID=35, WS=36, COMMENT=37;
	public static final int
		...
		RULE_functionWriteCell = 34, RULE_functionReadCell = 35, RULE_functionCopyCell = 36, 
		RULE_functionPrintLabelName = 37, RULE_functionPass = 38, RULE_idArgument = 39, 
		RULE_numberArgument = 40;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"functionWriteCell", "functionReadCell", "functionCopyCell", "functionPrintLabelName", 
			"functionPass", "idArgument", "numberArgument"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'IFEZ'", "'IFLZ'", "'IFGZ'", "'EXIT'", "'PRINT'", "'PRINTNL'", "'PRINT_CHAR'", 
			"'PRINTNL_CHAR'", "'WRITE_CELL'", "'READ_CELL'", "'COPY_CELL'", "'PRINT_LABEL_NAME'", 
			"'PASS'"
		};
	}
	...
	public final CellContext cell() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 17179868160L) != 0) {
				{
				setState(124);
				cellCode();
				}
	...
	public final CellCodeContext cellCode() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((_la) & ~0x3f) == 0 && ((1L << _la) & 17179868160L) != 0 );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final IdArgumentContext idArgument() throws RecognitionException {
		...
		enterRule(_localctx, 78, RULE_idArgument);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(287);
	...
	public final NumberArgumentContext numberArgument() throws RecognitionException {
		...
		enterRule(_localctx, 80, RULE_numberArgument);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(289);
